...
import com.cmu.mobilebff.model.RecommendationDto;
...
public class BookService {
  private static final String BOOK_SERVICE_URL =
      "http://book-service.bookstore-ns.svc.cluster.local:3000/books";
  //    private static final String BOOK_SERVICE_URL =
  // "http://internal-InternalALB-1285315458.us-east-1.elb.amazonaws.com:3000/books";
    ...
    Gson gson =
        new GsonBuilder()
            .setFieldNamingStrategy(
                new CustomFieldNamingStrategy()) // Set the custom field naming strategy here
            .create();
...
//                return ResponseEntity.ok(book);
        ...
        if (recommendationResponseEntity.getBody().isEmpty()) {
